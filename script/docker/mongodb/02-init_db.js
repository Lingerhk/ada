...
db.getCollection("tb_scan_template").insert([
    {
        _id: new ObjectId("6425b14857e6c3ceef50e461"),
        name: "Built-in Baseline Detection Template",
        type: "baseline",
        tmpl_type: NumberInt(1),
        plugins: [],
        create_tm: new Date(),
        update_tm: new Date(),
    },
    {
        _id: new ObjectId("6425b14857e6c3ceef50e462"),
        name: "Built-in Vulnerability Detection Template",
        type: "leak",
        tmpl_type: NumberInt(1),
        plugins: [],
        create_tm: new Date(),
    ...
    {
        _id: new ObjectId("6425b14857e6c3ceef50e463"),
        name: "Built-in Weak Password Detection Template",
        type: "weakpwd",
        tmpl_type: NumberInt(1),
        plugins: [],
        create_tm: new Date(),
